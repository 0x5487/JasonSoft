...
namespace JasonSoft.Components.Log4net.Util.TypeConverters
{
    /// <summary>
    ...
    public class ConversionNotSupportedException : ApplicationException
    {
        ...
        /// </para>
        /// </remarks>
        public ConversionNotSupportedException(String message, System.Exception innerException)
            ...
            if (sourceValue == null)
            {
                return
                    new ConversionNotSupportedException(
                        "Cannot convert value [null] to type [" + destinationType + "]", innerException);
            }
            else
            {
                return
