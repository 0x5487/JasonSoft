...
using JasonSoft.Components.Log4net.Util.TypeConverters;
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (meth != null)
                    {
                        ...
                        return
                            meth.Invoke(null, BindingFlags.InvokeMethod, null, new object[] {txt},
...
//		}
        ...
        public static object ConvertTypeTo(object sourceInstance, Type targetType)
        {
            ...
            throw new ArgumentException(
                "Cannot convert source object [" + sourceInstance.ToString() + "] to target type [" + targetType.Name +
                "]", "sourceInstance");
        }
