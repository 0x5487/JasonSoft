    ...
    public class NetSendAppender : AppenderSkeleton
    {
        ...
        protected override void Append(LoggingEvent loggingEvent)
        {
            ...
            using (m_securityContext.Impersonate(this))
            {
                // Send the message
                int returnValue =
                    NetMessageBufferSend(this.Server, this.Recipient, this.Sender, renderedLoggingEvent,
            ...
            if (nativeError != null)
            {
                ...
                ErrorHandler.Error(nativeError.ToString() + " (Params: Server=" + this.Server + ", Recipient=" +
                                   this.Recipient + ", Sender=" + this.Sender + ")");
            }
        }
