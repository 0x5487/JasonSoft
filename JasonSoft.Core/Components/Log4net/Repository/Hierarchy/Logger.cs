...
namespace JasonSoft.Components.Log4net.Repository.Hierarchy
{
    ...
    // NETCF: String.Intern causes Native Exception
        ...
        /// </para>
        /// </remarks>
        public virtual void Log(Type callerStackBoundaryDeclaringType, Level level, object message,
        ...
        /// </para>
        /// </remarks>
        public virtual void Log(Level level, object message, System.Exception exception)
        {
            if (IsEnabledFor(level))
            {
        ...
        {
            CallAppenders(
                new LoggingEvent(callerStackBoundaryDeclaringType, this.Hierarchy, this.Name, level, message, exception));
        }
