...
using JasonSoft.Components.Log4net.Layout.Pattern;
using JasonSoft.Components.Log4net.Util;
using JasonSoft.Components.Log4net.Util.PatternStringConverters;
using AppDomainPatternConverter=JasonSoft.Components.Log4net.Layout.Pattern.AppDomainPatternConverter;
using DatePatternConverter=JasonSoft.Components.Log4net.Layout.Pattern.DatePatternConverter;
using IdentityPatternConverter=JasonSoft.Components.Log4net.Layout.Pattern.IdentityPatternConverter;
using PropertyPatternConverter=JasonSoft.Components.Log4net.Layout.Pattern.PropertyPatternConverter;
using UserNamePatternConverter=JasonSoft.Components.Log4net.Layout.Pattern.UserNamePatternConverter;
using UtcDatePatternConverter=JasonSoft.Components.Log4net.Layout.Pattern.UtcDatePatternConverter;

namespace JasonSoft.Components.Log4net.Layout
{
    /// <summary>
