...
namespace JasonSoft.Components.Castle.Facilities.EventWiring
{
    /// <summary>
    ...
    public class EventWiringFacility : AbstractFacility
    {
        ...
        private void ExtractAndAddEventInfo(IDictionary subscribers2Evts, string subscriberKey,
                                            IConfiguration subscriber, ComponentModel model)
        {
            ...
            if (eventName == null || eventName.Length == 0)
            {
                throw new EventWiringException("You must supply an 'event' " +
                                               ...
                                               " Check node 'subscriber' for component " + model.Name + "and id = " +
                                               subscriberKey);
            }
