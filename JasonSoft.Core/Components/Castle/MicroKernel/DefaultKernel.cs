...
using JasonSoft.Components.Castle.Core.Internal;
using JasonSoft.Components.Castle.MicroKernel.ComponentActivator;
using JasonSoft.Components.Castle.MicroKernel.Handlers;
using JasonSoft.Components.Castle.MicroKernel.ModelBuilder;
using JasonSoft.Components.Castle.MicroKernel.Proxy;
using JasonSoft.Components.Castle.MicroKernel.Registration;
using JasonSoft.Components.Castle.MicroKernel.Releasers;
using JasonSoft.Components.Castle.MicroKernel.Resolvers;
using JasonSoft.Components.Castle.MicroKernel.SubSystems.Configuration;
using JasonSoft.Components.Castle.MicroKernel.SubSystems.Conversion;
using JasonSoft.Components.Castle.MicroKernel.SubSystems.Naming;
using JasonSoft.Components.Castle.MicroKernel.SubSystems.Resource;

namespace JasonSoft.Components.Castle.MicroKernel
{
    /// <summary>
    ...
    public class DefaultKernel : KernelEventSupport, IKernel, IDeserializationCallback
    {
                                 ...
                                 bool overwriteLifestyle)
        {
            ...
            if (LifestyleType.Undefined == lifestyle)
                throw new ArgumentException("The specified lifestyle must be Thread, Transient, or Singleton.",
                                            "lifestyle");
