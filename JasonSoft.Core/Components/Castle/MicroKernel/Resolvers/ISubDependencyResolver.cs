...
namespace JasonSoft.Components.Castle.MicroKernel
{
    ...
    public interface ISubDependencyResolver
    {
        ...
        object Resolve(CreationContext context, ISubDependencyResolver parentResolver, ComponentModel model,
        ...
        bool CanResolve(CreationContext context, ISubDependencyResolver parentResolver, ComponentModel model,
                        DependencyModel dependency);
    }
}