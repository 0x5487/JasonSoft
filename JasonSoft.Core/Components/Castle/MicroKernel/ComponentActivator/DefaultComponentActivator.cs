...
using JasonSoft.Components.Castle.Core.Interceptor;
using JasonSoft.Components.Castle.MicroKernel.LifecycleConcerns;

namespace JasonSoft.Components.Castle.MicroKernel.ComponentActivator
{
    /// <summary>
    ...
    public class DefaultComponentActivator : AbstractComponentActivator
    {
        ...
        protected virtual object CreateInstance(CreationContext context, object[] arguments, Type[] signature)
        {
            ...
            if (createProxy)
            {
                ...
                {
                    throw new ComponentActivatorException(
                        "ComponentActivator: could not proxy " + Model.Implementation.FullName, ex);
                }
            }
        ...
        protected virtual ConstructorCandidate SelectEligibleConstructor(CreationContext context)
        {
            ...
            {
                throw new ComponentActivatorException("Could not find eligible constructor for " +
