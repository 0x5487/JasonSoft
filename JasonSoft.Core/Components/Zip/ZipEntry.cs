...
namespace JasonSoft.Components.Zip
{
    ...
    public partial class ZipEntry
    {
        ...
        public ZipEntry()
        {
            ...
            _CompressionLevel = JasonSoft.Components.Zip.CompressionLevel.Default;
        ...
        public CompressionMethod CompressionMethod
        {
            ...
            set
            {
                ...
                if (_CompressionMethod == (Int16)CompressionMethod.None)
                    _CompressionLevel = JasonSoft.Components.Zip.CompressionLevel.None;
                else if (CompressionLevel == JasonSoft.Components.Zip.CompressionLevel.None)
                    _CompressionLevel = JasonSoft.Components.Zip.CompressionLevel.Default;
        ...
        public JasonSoft.Components.Zip.CompressionLevel CompressionLevel
        {
            ...
            set
            {
                ...
                if (value == JasonSoft.Components.Zip.CompressionLevel.Default && _CompressionMethod == (short)CompressionMethod.Deflate) return; // nothing to do
                _CompressionLevel = value;
                if (value == JasonSoft.Components.Zip.CompressionLevel.None && _CompressionMethod == (short)CompressionMethod.None)
                    return; // nothing more to do

                _CompressionMethod = (short)((_CompressionLevel == JasonSoft.Components.Zip.CompressionLevel.None)
        ...
        private JasonSoft.Components.Zip.CompressionLevel _CompressionLevel;
