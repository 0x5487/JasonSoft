...
namespace JasonSoft.Components.Zip
{
    ...
    public class ZipOutputStream : Stream
    {
        ...
        private void _Init(Stream stream, bool leaveOpen, string name)
        {
            ...
            Strategy = JasonSoft.Components.Zip.CompressionStrategy.Default;
            _name = name ?? "(stream)";
#if !NETCF
        ...
        ///   cref="JasonSoft.Components.Zip.CompressionStrategy "/>.
        /// </remarks>
        ...
        private JasonSoft.Components.Zip.CrcCalculatorStream _entryOutputStream;
...
#if !NETCF
        public JasonSoft.Components.Zip.ParallelDeflateOutputStream ParallelDeflater
        {
            get
            {
