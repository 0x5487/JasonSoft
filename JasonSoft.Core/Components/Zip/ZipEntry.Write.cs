...
namespace JasonSoft.Components.Zip
{
    ...
    public partial class ZipEntry
    {
        ...
        private bool WantReadAgain()
        {
            ...
            if (CompressionLevel == JasonSoft.Components.Zip.CompressionLevel.None) return false;
        ...
        private void FigureCompressionMethodForWriting(int cycle)
        {
            ...
            _CompressionMethod = (short)((CompressionLevel == JasonSoft.Components.Zip.CompressionLevel.None)
                                          ? 0x00
                                          : 0x08);
            return;
        ...
        private Int32 FigureCrc32()
        {
            if (_crcCalculated == false)
            {
                ...
                {
                    var output = new JasonSoft.Components.Zip.CrcCalculatorStream(Stream.Null);
                ...
                else
                {
                    ...
                    var crc32 = new JasonSoft.Components.Zip.CRC32();
        ...
        private void _WriteEntryData(Stream s)
        {
            ...
            try
            {
                ...
                Stream encryptor;
                Stream deflater;
                JasonSoft.Components.Zip.CrcCalculatorStream output;
                                         ...
                                         JasonSoft.Components.Zip.CrcCalculatorStream output)
        {
            ...
            if ((deflater as JasonSoft.Components.Zip.DeflateStream) != null)
                deflater.Close();
#if !NETCF
            else if ((deflater as JasonSoft.Components.Zip.ParallelDeflateOutputStream) != null)
                deflater.Close();
#endif
        ...
        internal void PrepOutputStream(Stream s,
                                       ...
                                       out Stream deflater,
                                       out JasonSoft.Components.Zip.CrcCalculatorStream output)
        {
            ...
            output = new JasonSoft.Components.Zip.CrcCalculatorStream(deflater, true);
        }
        ...
        {
            if (_CompressionMethod == 0x08 && CompressionLevel != JasonSoft.Components.Zip.CompressionLevel.None)
            {
#if !NETCF
                     ...
                     _container.ParallelDeflateThreshold > 0L))
                {
                    ...
                    if (_container.ParallelDeflater == null)
                    {
                        _container.ParallelDeflater =
                            new JasonSoft.Components.Zip.ParallelDeflateOutputStream(s,
                                                                       CompressionLevel,
                                                                       _container.Strategy,
                                                                       true);
                    ...
                    JasonSoft.Components.Zip.ParallelDeflateOutputStream o1 = _container.ParallelDeflater;
                    o1.Reset(s);
                    return o1;
                }
#endif
                var o = new JasonSoft.Components.Zip.DeflateStream(s, JasonSoft.Components.Zip.CompressionMode.Compress,
                                                     CompressionLevel,
                                                     true);
                if (_container.CodecBufferSize > 0)
