...
namespace JasonSoft.Components.Zip
{
    ...
    public partial class ZipEntry
    {
        ...
        ///
        /// <para>
        /// The return value is a <see cref="JasonSoft.Components.Zip.CrcCalculatorStream"/>.  Use it
        ...
        /// <see cref="JasonSoft.Components.Zip.CrcCalculatorStream.Crc"/> property on the
        ...
        public JasonSoft.Components.Zip.CrcCalculatorStream OpenReader()
        {
        ...
        /// <param name="password">The password to use for decrypting the entry.</param>
        /// <returns>The Stream for reading.</returns>
        public JasonSoft.Components.Zip.CrcCalculatorStream OpenReader(string password)
        {
        ...
        internal JasonSoft.Components.Zip.CrcCalculatorStream InternalOpenReader(string password)
        {
            ValidateCompression();
            ValidateEncryption();
            ...
            return new JasonSoft.Components.Zip.CrcCalculatorStream(input3, LeftToRead);
        }
...
//                 else
        ...
        private Int32 _ExtractOne(Stream output)
        {
            ...
            using (var s1 = new JasonSoft.Components.Zip.CrcCalculatorStream(input3))
            {
                while (LeftToRead > 0)
                {
        ...
        internal Stream GetExtractDecompressor(Stream input2)
        {
            ...
            Stream input3 = (_CompressionMethod_FromZipFile == (short)CompressionMethod.None)
                ? input2
                : new JasonSoft.Components.Zip.DeflateStream(input2, JasonSoft.Components.Zip.CompressionMode.Decompress, true);
            return input3;
        }
