...
namespace JasonSoft.Components.Zip
{
    public partial class ZipFile
    {
        ...
        /// </remarks>
        ///
        /// <seealso cref="ZipFile.AddFile(string)"/>
        /// <seealso cref="ZipFile.AddDirectory(string)"/>
        /// <seealso cref="ZipFile.UpdateItem(string)"/>
        ///
        ...
        /// </param>
        ///
        /// <seealso cref="ZipFile.AddFile(string, string)"/>
        /// <seealso cref="ZipFile.AddDirectory(string, string)"/>
        /// <seealso cref="ZipFile.UpdateItem(string, string)"/>
        ///
        /// <example>
        ...
        /// <overloads>This method has two overloads.</overloads>
        ///
        /// <seealso cref="ZipFile.AddItem(string)"/>
        /// <seealso cref="ZipFile.AddDirectory(string)"/>
        /// <seealso cref="ZipFile.UpdateFile(string)"/>
        ///
        /// <param name="fileName">
        ...
        /// </example>
        ///
        /// <seealso cref="ZipFile.AddItem(string,string)"/>
        /// <seealso cref="ZipFile.AddDirectory(string, string)"/>
        /// <seealso cref="ZipFile.UpdateFile(string,string)"/>
        ///
        /// <param name="fileName">
        ...
        /// </param>
        ///
        /// <seealso cref="ZipFile.SelectEntries(String)" />
        /// <seealso cref="ZipFile.RemoveSelectedEntries(String)" />
        ...
        /// </example>
        ///
        /// <seealso cref="ZipFile.AddSelectedFiles(String, String)" />
        ...
        ///
        /// <seealso cref="ZipFile.AddFile(string)"/>
        /// <seealso cref="ZipFile.UpdateDirectory(string)"/>
        /// <seealso cref="ZipFile.UpdateItem(string)"/>
        ///
        /// <param name="fileName">
        ...
        ///
        /// <seealso cref="ZipFile.AddFile(string,string)"/>
        /// <seealso cref="ZipFile.UpdateDirectory(string,string)"/>
        /// <seealso cref="ZipFile.UpdateItem(string,string)"/>
        ///
        /// <param name="fileName">
        ///   The name of the file to add or update. It should refer to a file in the
        ...
        /// </example>
        ///
        /// <seealso cref="ZipFile.UpdateEntry(string, System.IO.Stream)"/>
        ///
        /// <param name="entryName">
        ...
        /// </remarks>
        ///
        /// <seealso cref="ZipFile.AddEntry(string, System.IO.Stream)"/>
