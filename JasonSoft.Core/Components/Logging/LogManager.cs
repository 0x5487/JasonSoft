...
using JasonSoft.Components.Logging.Configuration;
using JasonSoft.Components.Logging.Simple;

namespace JasonSoft.Components.Logging
{
    /// <summary>
    ...
    public static class LogManager
    {
        ...
        /// </remarks>
        public static readonly string COMMON_LOGGING_SECTION = "JasonSoft/Logging";
        ...
        /// <summary>
        /// Reset the <see cref="JasonSoft.Components.Logging" /> infrastructure to its default settings. This means, that configuration settings
        ...
        private static ILoggerFactoryAdapter BuildLoggerFactoryAdapter()
        {
            ...
            ArgUtils.Guard(delegate
                ...
                , "Failed obtaining configuration for JasonSoft.Components.Logging from configuration section 'JasonSoft/Logging'.");
