...
using JasonSoft.Components.SmartThreadPool.Internal;
...
namespace JasonSoft.Components.SmartThreadPool
{
	...
	public class SmartThreadPool : WorkItemsGroupBase, IDisposable
	{
		...
		{
			int threadsCount = System.Math.Max(_workItemsQueue.Count, _stpStartInfo.MinWorkerThreads);
			threadsCount = System.Math.Min(threadsCount, _stpStartInfo.MaxWorkerThreads);
