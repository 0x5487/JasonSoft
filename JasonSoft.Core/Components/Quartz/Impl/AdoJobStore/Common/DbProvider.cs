...
namespace JasonSoft.Components.Quartz.Impl.AdoJobStore.Common
{
    /// <summary>
    ///     
    /// </summary>
    ...
    public class DbProvider : IDbProvider
    {
        ...
        protected const string DbProviderResourceName = "JasonSoft.Components.Quartz.Impl.AdoJobStore.Common.dbproviders.properties";
